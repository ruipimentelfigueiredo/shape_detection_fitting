...
compute mean.binaryproto /home/rui/mot/lib/caffe/build/tools/compute_image_mean -backend=lmdb $DIR/Cylinders/dataset_v3/train_lmdb $DIR/Cylinders/dataset_v3/mean.binaryproto

# 4. train the network with the lmdb - mean data
/home/rui/mot/lib/caffe/build/tools/caffe train --solver=$DIR/squeezenet/solver.prototxt --weights $DIR/squeezenet/squeezenet_v1.1.caffemodel 2>&1 | tee $DIR/Cylinders/dataset_v3/model_1_train.log
