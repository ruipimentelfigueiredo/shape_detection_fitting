...
'''
    Adapted from https://github.com/jsbruglie/gap
    Copyright (C) 2018 Joao Borrego
...
class ImageViewer(tk.Frame):
    ...
    def onUpdate(self):
        ...
        # Filenames
        img_file = self.img_dir + '/' + str(int(self.cur)).zfill(5) + self.img_ext
        data_file = self.data_dir + '/' + str(self.cur).zfill(5) + EXT_DATA
        ...
        for obj in annotation.findall('object'):
            ...
            color = BOX_COLOR
            if   (name == "other"):   color = OTHER_COLOR
