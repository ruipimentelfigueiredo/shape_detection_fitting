...
boost::shared_ptr<pcl::visualization::PCLVisualizer> CylinderSegmentationHough::simpleVis (PointCloudT::ConstPtr cloud,  pcl::PointCloud<pcl::Normal>::ConstPtr normals, pcl::ModelCoefficients::Ptr coefficients_cylinder)
{
